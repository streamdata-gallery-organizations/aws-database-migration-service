...
- name: AWS Database Migration Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-database-migration-service/master/_listings/aws-database-migration-service/action-testconnection-get.md
x-common:
